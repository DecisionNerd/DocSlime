<!-- LLM: This file is the index for the Architecture Decision Records. It is NOT itself an ADR. Keep it as a short explainer plus a table of the decisions recorded so far. When you add or fill in an ADR, add a row to the log below. Remove LLM comments as you go. -->
